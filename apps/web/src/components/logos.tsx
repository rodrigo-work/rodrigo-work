...
export function NodeJsLogo({ className }: { className: string }): JSX.Element {
  return (
    ...
    >
      ...
      <mask height="16" id="mask0_872_3158" maskUnits="userSpaceOnUse" width="14" x="1" y="0">
        <path
      ...
      <mask height="16" id="mask1_872_3158" maskUnits="userSpaceOnUse" width="14" x="1" y="0">
        <path
      ...
      <mask height="16" id="mask2_872_3158" maskUnits="userSpaceOnUse" width="14" x="1" y="0">
        <path
...
export function TurborepoLogo({ className }: { className?: string }): JSX.Element {
  return (
    <svg
...
export function DesignSystemLogo({ className }: { className?: string }): JSX.Element {
  return (
    <svg
      className={className}
      fill="none"
      ...
      width="24"
    >
      <title>Design System Logo</title>
      <path
        clipRule="evenodd"
